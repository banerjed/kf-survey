...
function FoodSecuritySurveyListTable(props) {
  const [
    recordIdToDestroy,
  ...
  const hasPermissionToEdit = useSelector(
    foodSecuritySurveySelectors.selectPermissionToEdit,
  );
        ...
        >
          <TableHead>
            <TableRow>
              ...
              <TableCellCustom
                label={i18n(
                  'entities.foodSecuritySurvey.fields.household',
                )}
              />
              <TableCellCustom
                onSort={doChangeSort}
                ...
                name={'surveyDate'}
                label={i18n(
                  'entities.foodSecuritySurvey.fields.surveyDate',
                )}
              />
              <TableCellCustom
                onSort={doChangeSort}
                ...
                name={'enoughToEat'}
                label={i18n(
                  'entities.foodSecuritySurvey.fields.enoughToEat',
                )}
              />
              <TableCellCustom
                onSort={doChangeSort}
                ...
                name={'proteinSource'}
                label={i18n(
                  'entities.foodSecuritySurvey.fields.proteinSource',
                )}
              />              
            ...
            {!loading &&
              rows.map((row) => (
                ...
                <TableCell>
                  {row.enoughToEat
                    ? i18n(
                        `entities.foodSecuritySurvey.enumerators.enoughToEat.${row.enoughToEat}`,
                      )
                    : null}
                </TableCell>
                <TableCell>
                  {row.proteinSource
                    ? i18n(
                        `entities.foodSecuritySurvey.enumerators.proteinSource.${row.proteinSource}`,
                      )
                    : null}
                </TableCell>                  
                  <TableCell>
                    ...
                    >
                      <Tooltip title={i18n('common.view')}>
                        <IconButton
                          component={Link}
                          color="primary"
                          to={`/food-security-survey/${row.id}`}
                        >
                          <SearchIcon />
                        </IconButton>
                      </Tooltip>
                      {hasPermissionToEdit && (
                        ...
                        >
                          <IconButton
                            color="primary"
                            component={Link}
                            to={`/food-security-survey/${row.id}/edit`}
                          >
                            <EditIcon />
                          </IconButton>
                        </Tooltip>
...
export default FoodSecuritySurveyListTable;
