...
function GovtBenefitsSurveyToolbar(props) {
  const [
  ...
  const hasPermissionToCreate = useSelector(
    govtBenefitsSurveySelectors.selectPermissionToCreate,
  );
  const hasPermissionToImport = useSelector(
    govtBenefitsSurveySelectors.selectPermissionToImport,
  );
    ...
    <ToolbarWrapper>
      ...
      {hasPermissionToImport && (
        <Button
          ...
          color="primary"
          component={Link}
          to="/govt-benefits-survey/importer"
      ...
      {hasPermissionToAuditLogs && (
        <Button
          component={Link}
          to="/audit-logs?entityNames=govtBenefitsSurvey"
...
export default GovtBenefitsSurveyToolbar;
